...
/**
 * @ai-context Input component with label, error state, and password toggle.
 * @ai-props
 *   - label: Label text displayed above input
 *   - error: Error message displayed below input
 *   - leftIcon/rightIcon: Icons to display inside input
 *   - showPasswordToggle: Shows eye icon for password fields
 * @ai-a11y
 *   - Label properly associated with input via id
 *   - Error message linked with aria-describedby
 *   - Invalid state conveyed with aria-invalid
 */
