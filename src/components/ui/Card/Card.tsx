...
/**
 * @ai-context Sophisticated Card component for Le Pas Sage ecommerce.
 *             Implements refined black/white/gold aesthetic.
 * @ai-props
 *   - variant: Visual style (default, premium, elevated, glass, outline, flat)
 *   - hoverable: Enables hover lift effect with cursor pointer
 * @ai-flow
 *   Composable with CardHeader, CardContent, CardFooter for flexible layouts
 * @ai-a11y
 *   - Proper semantic HTML structure
 *   - Hoverable cards get cursor:pointer for affordance
 */
  ...
  'rounded-xl transition-sophisticated',
  {
    variants: {
      variant: {
        ...
        // Premium - Luxury card with gold accent
        premium:
