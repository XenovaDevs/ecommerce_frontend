...
export function PromoBanner() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-sage-black via-gray-900 to-sage-black py-16 sm:py-20">
      ...
      <div
        ref={ref}
        className={`relative mx-auto max-w-4xl px-6 sm:px-8 text-center transition-all duration-700 ${
          isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
        }`}
      >
        <div className="inline-flex items-center gap-2 rounded-full bg-sage-gold/10 border border-sage-gold/20 px-4 py-1.5 mb-6">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-sage-white tracking-tight leading-[1.1] font-display">
          Hasta <span className="text-gradient-gold">30% OFF</span>
          <br />
